...
from DataGenerators.Datagenerator import Datageneratorbasic
from scipy import signal # for rectangular signal
...
class ImbalancedDataGenerator(Datageneratorbasic):
    'Generates Windows'
